                ...
                while ($row = mysqli_fetch_assoc($result_tasks)) {
                    ...
                    if ((($rows > 6 && $i % 6 == 0) || ($rows <= 6 && $rows > 0)) && $divClosed) {
                        ...
                        <div class="col-sm-6 col-xs-6 col-md-6">
                            <!--Check if its single door frame or double door and show handles accordingly -->
                            <?php 
                            echo '<script>console.log('.strpos($_COOKIE["FrameName"], "Single").')</script>';
                            if (strpos($_COOKIE["FrameName"], "Single") !== false) { ?>
                                <a onclick="getHandle('images/Handles/<?php echo $row['SingleImage']; ?>')">
                                    <img src="images/Handles/<?php echo $row['SingleImage']; ?>" class="img-responsive" alt="Image" />
                                </a>
                                <?php } else{
                                ?>
