        ...
        <div class="container-fluid">
            <div class="row">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result_tasks)) {
                                        ...
                                        if ((($rows > 6 && $i % 6 == 0) || ($rows <= 6 && $rows > 0)) && $divClosed) {
                                            ...
                                            <div class="col-sm-6 col-xs-6 col-md-6">
                                                <a onclick="getFrame('images/Frames/<?php echo $row['Image']; ?>', '<?php echo $row['ID']; ?>', '<?php echo $row['Name']; ?>')">
                ...
                <div id="step5" style="display: none;">
                    <div class="col-md-3 col-sm-4">
                        <div class="steps">
                            <h1>Step 5 : Select Lock</h1>
                            <div class="gold-box">
                                <h2>Locks For Door</h2>
                                <div id="owl2" class="owl-carousel owl-theme">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result_tasks)) {
                                        ...
                                        if ((($rows > 6 && $i % 6 == 0) || ($rows <= 6 && $rows > 0)) && $divClosed) {
                                            ...
                                            ?>
                                            <div class="col-sm-6 col-xs-6 col-md-6">
                                                <a onclick="getLock('images/Locks/<?php echo $row['Image']; ?>')">
                                                    <img src="images/Locks/<?php echo $row['Image']; ?>" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <?php
                                            $rowCounter--;
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <a href="#" onclick="replace('step5', 'step4');">
                                ...
                                <div class="col-xs-6">
                                    <a href="#" onclick="replace('step5', 'step6');">
                                        <svg style="float: right;" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                             width="20px" height="20px" viewBox="0 0 284.936 284.936" style="enable-background:new 0 0 284.936 284.936;"
                                             xml:space="preserve">
                                            <g>
