...
<section>
        <div class="wow fadeIn">
                                ...
                                <div class="gold-box">
                                    ...
                                    <div id="owl1" class="owl-carousel owl-theme">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_Door design-02.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_Door design-03.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_single door-07.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_single door-09.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_single door-08.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="gold-box">
                                    ...
                                    <div id="owl2" class="owl-carousel owl-theme">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_Door design-04.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_Door design-05(1).png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>

                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_single door-14.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_single door-15.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                            <div class="col-sm-6">
                                                <a href="#">
                                                    <img src="images/Abby_single door-13.png" class="img-responsive" alt="Image" />
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row">
			...
			s4.664-0.951,6.567-2.854l133.042-133.044C169.785,147.136,170.732,144.945,170.732,142.471z" />
                    ...
                    <div class="col-sm-2">
                        <div class="reminder">
                            <p class="text-center">(Reminder: Please contact with Wrought Iron Shop team after design the door if you require side lights)</p>
                        </div>
                    </div>
                </div>
            </div>
