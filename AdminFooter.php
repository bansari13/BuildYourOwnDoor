<footer class="main-footer">
        ...
        <aside class="control-sidebar control-sidebar-dark">
            ...
            <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
                <li class="nav-item"><a href="#control-sidebar-home-tab" data-toggle="tab" style="  display: none;"><i class="fa fa-home"></i></a></li>
    ...
    <div>
        ...
        <script src="js/Admin/jquery.richtext.min.js" type="text/javascript"></script>
        <!-- popper -->
        ...
        <script src="js/Admin/jquery.steps.js"></script>
